...
- The defaults are hard-coded in `main.tf`: region `eu-west-2`, cluster name `my-cluster`, and Kubernetes version `1.35`.
...
- This stack stores state in S3 at `s3://noa-tf-state-658786808637-eu-west-2-an/terraform-eks-small/terraform.tfstate`.
