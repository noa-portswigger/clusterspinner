...
# The base policy document is sourced from:
# https://raw.githubusercontent.com/kubernetes-sigs/aws-load-balancer-controller/main/docs/install/iam_policy.json
#
# Additional conditions have been applied to tighten the policy, as recommended in:
# https://kubernetes-sigs.github.io/aws-load-balancer-controller/v3.1/deploy/installation/#option-a-recommended-iam-roles-for-service-accounts-irsa
#
# Specifically:
